...
use It_All\BoutiqueCommerce\Middleware\AuthenticationMiddleware;
...
$slim->get('/' . $config['dirs']['admin'],
    'It_All\BoutiqueCommerce\UI\Views\Admin\AuthenticationView:getLogin')
    ->add(new GuestMiddleware($container))
    ->setName('authentication.login');

$slim->post('/' . $config['dirs']['admin'],
    'It_All\BoutiqueCommerce\Controllers\AuthenticationController:postLogin')
    ->add(new GuestMiddleware($container))
...
$slim->get('/' . $config['dirs']['admin'] . '/logout',
    'It_All\BoutiqueCommerce\UI\Views\Admin\AuthenticationView:getLogout')
    ->setName('authentication.logout');

// admins
$slim->get('/' . $config['dirs']['admin'] . '/admins/insert',
    'It_All\BoutiqueCommerce\UI\Views\Admin\AdminsView:getInsert')
    ->setName('admins.insert');

$slim->post('/' . $config['dirs']['admin'] . '/admins/insert',
    'It_All\BoutiqueCommerce\Controllers\AdminsController:postInsert')
