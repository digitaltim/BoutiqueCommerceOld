...
class DbTable {
    ...
    function __construct(string $tableName)
    {
        ...
        if(!$this->dbTableMetaRes = Postgres::getTableMetaData($this->tableName)) {
    ...
    private function addColumnsToBuilder(QueryBuilder $qb, array $columnValues, array $updateRow = null)
    {
    ...
    public function select(string $columns = "*", array $whereArr = [], string $orderByOverride = null, string $limitOverride = null)
    {
        ...
        if ($limitOverride === 0) {
            $limit = "";
        } elseif (ValidationService::isInteger($limitOverride)) {
