...
class OrdersController extends Controller
{
    function putUpdate($request, $response, $args)
    {
        ...
        if ($error) {
            ...
            return (new OrdersView($this->container))->getUpdate($request, $response, $args);
        }
    }
    ...
    function postInsert($request, $response, $args)
    {
        ...
        if ($error) {
            ...
            return (new OrdersView($this->container))->getInsert($request, $response, $args);
        }
    }
